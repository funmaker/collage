...
import { Button, Divider, Image, Input, Loader, Modal } from "semantic-ui-react";
...
export default class ImageClipper extends Component {
  ...
  async clip() {
    ...
    for(let i = 3, n = img.width * img.height * 4; i < n; i += 4) {
      pixels[i] = 255;
    }
  ...
  render() {
    ...
    const google = <a href={`http://images.google.com/searchbyimage?image_url=${encodeURIComponent(image.src)}`} rel="noopener noreferrer" target="_blank">Search Google</a>;
